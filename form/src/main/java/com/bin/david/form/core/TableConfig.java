...
public class TableConfig {
     ...
     * 系列格式
     */
    private BaseSequenceFormat ySequenceCount;
    ...
    public TableConfig setYSequenceFormat(BaseSequenceFormat ySequenceCount) {
        this.ySequenceCount = ySequenceCount;
        return this;
    }

    public BaseSequenceFormat getYSequenceFormat() {
        return ySequenceCount;
    }
}
